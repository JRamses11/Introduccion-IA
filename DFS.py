...
def DFS(F, ax):
    ...
    def DFS_recursivo(F):
        ...
        plt.pause(0.0001)  # Pausa para visualizar el estado antes de avanzar (ajusta el valor para cambiar la velocidad)

        return DFS_recursivo(F)  # Llamar recursivamente a la función con la nueva lista F

    return DFS_recursivo(F)
